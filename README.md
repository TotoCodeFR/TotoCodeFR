...
I'm a full-stack developer with a focus on TypeScript, Node.js, React, and Luau. I design and build desktop applications, backend systems, and developer tools.

![Toto's GitHub Stats](https://ghstats.dev/api/card?username=TotoCodeFR&border_radius=12&size=compact)

<!-- thanks to RiskyMH for the Github repo icon :) -->
...
- **Languages:** TypeScript, JavaScript, Luau
- **Frontend:** React, HTML, CSS
- **Backend:** Node.js, API Design, Server Architecture
- **Desktop:** Electron
- **Databases:** PostgreSQL, SQLite
- **Tools:** Git, npm, pnpm, bun
...
I mostly respond on Discord, so contact me there.
